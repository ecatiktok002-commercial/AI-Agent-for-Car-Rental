...
async function run() {
  ...
  await test("Saga", "2026-04-19");
  await test("Proton Saga", "2026-04-19");
  
  console.log("--- Testing With Times ---");
  await test("Saga", "2026-04-19 11:00:00");
  await test("Proton Saga", "2026-04-19 11:00:00");
  
  console.log("--- Testing With Times 2 ---");
  await test("Saga", "2026-04-19 12:30:00");
  await test("Proton Saga", "2026-04-19 12:30:00");
}
run();
