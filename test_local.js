...
async function run() {
  await test("PROTON SAGA", "2026-04-19 19:00:00");
  await test("PROTON SAGA", "2026-04-19 19:00");
  await test("PROTON SAGA", "19/04/2026 19:00");
  await test("PROTON SAGA", "19/04/2026 07:00 PM");
}
run();
