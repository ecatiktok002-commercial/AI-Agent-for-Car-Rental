...
async function run() {
  await test("PROTON SAGA", "2026-04-19 19:00:00+08");
  await test("PROTON SAGA", "2026-04-19 19:00:00+08:00");
  await test("PROTON SAGA", "2026-04-19 07:00:00 PM");
  await test("PROTON SAGA", "2026-04-19T19:00");
}
run();
