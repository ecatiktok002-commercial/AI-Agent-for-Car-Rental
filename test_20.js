...
async function run() {
  await test("PROTON SAGA", "2026-04-20");
  await test("PROTON SAGA", "2026-04-20 19:00:00");
  await test("PROTON SAGA", "2026-04-20T19:00:00");
  await test("Saga", "2026-04-20");
  await test("Bezza", "2026-04-20");
  await test("PERODUA BEZZA", "2026-04-20");
}
run();
